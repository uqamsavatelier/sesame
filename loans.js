import { requireSessionOrRedirect, getMyProfile, signOut, isPendingApprovalRole, redirectToRoleHome, notifyAdminAboutPendingUsers } from "./auth.js?v=20260415c";
import {
  listCabinets,
  listLoansAll,
  listLoansByBorrower,
...
function applyRestrictedMobileLayout() {
  document.body.classList.toggle("scan-cabinet-view", getModeFromUrl() === "qr");
}
